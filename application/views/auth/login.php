...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo base_url() ?>assets/backend/template/assets/fonts/fontawesome/css/fontawesome-all.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url() ?>assets/backend/template/assets/plugins/animation/css/animate.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/backend/template/assets/css/style.css">
    <link rel="stylesheet"
        href="<?php echo base_url() ?>assets/backend/template/assets/plugins/notification/css/notification.min.css">
    <style>
    .alert span {
        cursor: pointer;
        padding-right: 5px;
...
<body class="auth-prod-slider">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-5">
                        <div class="card-body">
                            ...
                            <img src="<?php echo base_url() ?>assets/backend/template/assets/images/SISTA3.png" alt=""
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        <img src="<?php echo base_url() ?>assets/backend/template/assets/images/product/Qr.jpg"
                                            alt="product images" class="img-fluid mb-3">
                                        <h5>Sistem Informasi Seminar Tugas Akhir(SISTA) </h5>
                                        <p class="mb-5">Sistem pendaftaran seminar Tugas Akhir menggunakan QR Code</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="auth-prod-slidebg bg-2"></div>
                                    <div class="carousel-caption d-none d-md-block">
                                        <img src="<?php echo base_url() ?>assets/backend/template/assets/images/product/sttnf.png"
                                            alt="product images" class="img-fluid mb-5">
                                        <h5>Memudahkan pengguna untuk melakukan pendaftaran seminar
                                            Tugas Akhir </h5>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        <img src="<?php echo base_url() ?>assets/backend/template/assets/images/product/scan3.png"
                                            alt="product images" class="img-fluid mb-5">
    ...
    <script src="<?php echo base_url() ?>assets/backend/template/assets/plugins/notification/js/bootstrap-growl.min.js">
    </script>
