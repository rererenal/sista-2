                    ...
                    <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $s->pmb ?></td>
                                <td><?php echo $s->pgj1 ?></td>
                                <td><?php echo $s->pgj2 ?></td>
                                <td><?php echo $s->rg ?></td>
                                <td>
                                    <div class="col-sm-12 ">
                                        <a href="<?php echo base_url("uploads/poster/{$s->lampiran}") ?>"
                                            data-lightbox="example-set" data-title="<?php echo $s->nama_seminar ?>">
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-sm btn-gradient-dark" data-toggle="tooltip"
                                        data-placement="top" title=""
                                        data-original-title="Silahkan Masukkan Data Tiket, Pembicara, dan Sponsor"><i
