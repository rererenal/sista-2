...
<div class="row">
    <div class="col-md-5 col-xl-5">
        <div class="card" style="height:630px;">
            <img class="img-fluid img-thumbnail" src="<?php echo base_url() ?>uploads/poster/<?= $lampiran ?>"
                alt="Profile-user">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="media">
                                    <div class="media-left">
                                        <a class="btn btn-outline-primary btn-icon" href="#!" role="button"><i
                                                class="fas fa-at"></i>
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="chat-header">Judul Seminar</div>
                            ...
                            <div class="col-sm-6">
                                <div class="media">
                                    <div class="media-left">
                                        <a class="btn btn-outline-warning btn-icon" href="#!" role="button"><i
                            ...
                            <div class="col-sm-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="chat-header">Dosen Pembimbing</div>
                                        <p class="chat-header text-muted"><?= $pmb ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="chat-header">Dosen Penguji 1</div>
                                        <p class="chat-header text-muted"><?= $pgj1 ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="chat-header">Dosen Penguji 2</div>
                                        <p class="chat-header text-muted"><?= $pgj2 ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="chat-header">Ruangan</div>
                                        <p class="chat-header text-muted"><?= $rg ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="media">
                                    <div class="media-left">
                                        <a class="btn btn-outline-danger btn-icon" href="#!" role="button"><i
            ...
            <div class="col-md-12">
                <div class="card" style="height:300px;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <img class="img-responsive imgA1"
                                    src="<?php echo base_url("uploads/tiket/{$foto_tiket}"); ?>" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card bg-dark rounded-0 shadow-none">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    ...
                                    <img src="<?php echo base_url("uploads/sponsor/{$s->gambar}") ?>" alt=""
        ...
        <div class="card user-card user-card-2 shape-center card-pembicara">
            <div class="card-header border-0 p-2 pb-0">
                <div class="cover-img-block">
                    <img src="<?php echo base_url() ?>assets/images/widget/SISTA.png" alt="" class="img-fluid sampul">
                </div>
            </div>
            <div class="card-body pt-0">
                <div class="user-about-block text-center">
                    <div class="row align-items-end">
                        <div class="col text-left pb-3"><a href="#!"><i
                                    class="icon feather icon-star-on text-c-yellow f-20"></i></a>
                        </div>
                        <div class="col">
                            <div class="position-relative d-inline-block">
                                <img class="img-radius img-fluid wid-80 pembicara"
                                    src="<?php echo base_url("uploads/pembicara/{$p->foto}") ?>" alt="User image">
