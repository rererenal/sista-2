    ...
    <div class="navbar-wrapper ">
        ...
        <div class="navbar-content scroll-div">
            <ul class="nav pcoded-inner-navbar ">
                ...
                <li data-username="home" class="nav-item"><a href="<?= site_url('home') ?>" class="nav-link"><span
                ...
                <li data-username="widget statistic data chart" class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i
                                class="feather icon-layers"></i></span><span class="pcoded-mtext">Master Data</span>
                    </a>
                ...
                <li data-username="widget statistic data chart" class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i
                                class="feather icon-mic"></i></span><span class="pcoded-mtext">Data Seminar TA</span>
                    </a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="<?= site_url('seminar') ?>" class="">Data Seminar TA</a></li>
                        <li class=""><a href="<?= site_url('tiket') ?>" class="">Data Tiket Seminar TA</a></li>
                        <li class=""><a href="<?= site_url('pembicara') ?>" class="">Data Pembicara</a></li>
                        <li class=""><a href="<?= site_url('sponsor') ?>" class="">Data Sponsor</a></li>
                    </ul>
                </li>
                <li data-username="pendaftaran" class="nav-item"><a href="<?= site_url('pendaftaran') ?>"
                        class="nav-link"><span class="pcoded-micon"><i class="feather icon-book"></i></span><span
                            class="pcoded-mtext">Pendaftaran Seminar TA</span></a></li>
                <li data-username="extra components session timeout session idle timeout offline"
                    class="nav-item pcoded-hasmenu">
                    <a href="#!" class="nav-link"><span class="pcoded-micon"><i
                                class="feather icon-grid"></i></span><span class="pcoded-mtext">Data QR Code</span></a>
                    <ul class="pcoded-submenu">
                        <li class=""><a href="<?= site_url('genqr') ?>" class="">Ambil QR Code</a></li>
                        <li class=""><a href="<?= site_url('scan') ?>" class="">Scan QR Code</a></li>
                    </ul>
                </li>
                <li data-username="animations" class="nav-item"><a href="<?= site_url('laporan') ?>"
                        class="nav-link"><span class="pcoded-micon"><i class="feather icon-clipboard"></i></span><span
                            class="pcoded-mtext">Laporan Pendaftaran Seminar TA</span></a></li>
            </ul>
        </div>
    </div>
</nav>