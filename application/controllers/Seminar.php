...
class Seminar extends CI_Controller
{
    ...
    public function add()
    {
         ...
         * $dosen_pembimbing
         *
         * @param	string	'Dosen Pembimbing'
         * @param	string	'pmb'	
         * @return	void
         */
        $lpmb = form_label('Dosen Pembimbing', 'pmb');
        /**
         * $dosen_penguji1
         *
         * @param	string	'Dosen Penguji 1'	
         * @param	string	'pgj1'	
         * @return	void
         */
        $lpgj1 = form_label('Dosen Penguji 1', 'pgj1');
        /**
         * $dosen_penguji2
         *
         * @param	string	'Dosen Penguji 2'	
         * @param	string	'pgj2'	
         * @return	void
         */
        $lpgj2 = form_label('Dosen Penguji 2', 'pgj2');
        /**
         * $lrg.
         *
         ...
         * $i_pmb.
         *
         * @param	mixed	$attr_pmb	
         * @return	void
         */
        $i_pmb = form_input($attr_pmb);
        /**
         * $i_pgj1.
         *
         * @param	mixed	$attr_pgj1	
         * @return	void
         */
        $i_pgj1 = form_input($attr_pgj1);
        /**
         * $i_pgj2.
         *
         * @param	mixed	$attr_pgj2	
         * @return	void
         */
        $i_pgj2 = form_input($attr_pgj2);
        /**
         * $i_hargatiket.
         *
    ...
    public function uploadaction()
    {
        ...
        if (isset($file)) {
            ...
            $tiket = ($fcpatht . $file);
            if (unlink($tiket) && unlink($thumbnail)) {
            } else {
                echo "error";
            }
        }
    ...
    public function addaction()
    {
        ...
        if ($validasi ==  FALSE) {
            ...
            if (!$this->upload->do_upload('lampiran')) {
                ...
                /**
                 * @var		mixed	$this->input->post('pmb'
                 */ /**
                 * @var		mixed	TRUE)
                 */
                $pmb = $this->input->post('pmb', TRUE);
                /**
                 * @var		mixed	$this->input->post('pgj1'
                 */ /**
                 * @var		mixed	TRUE)
                 */
                $pgj1 = $this->input->post('pgj1', TRUE);
                /**
                 * @var		mixed	$this->input->post('pgj2'
                 */ /**
                 * @var		mixed	TRUE)
                 */
                $pgj2 = $this->input->post('pgj2', TRUE);
                /**
                 * @var		mixed	$this->input->post('rg'
                 */ /**
                 * @var		mixed	TRUE)
                 */
    ...
    public function editaction()
    {
         ...
         * @var		mixed	$this->input->post('pgj1')
         */
        $pgj1 = $this->input->post('pgj1');
        /**
         * @var		mixed	$this->input->post('pgj2')
         */
        $pgj2 = $this->input->post('pgj2');
        /**
         * 
         * @var		mixed	$this->input->post('rg')
         */
    ...
    public function _rules()
    {
         ...
         */
        $attr_pmb = array(
            'required' => 'Nama Dosen Pembimbing harus di isi!',
        );
        /**
         * @var		mixed	$attr_pgj1
         */
        $attr_pgj1 = array(
            'required' => 'Nama Dosen Penguji 1 harus di isi!',
        );
        /**
         * @var		mixed	$attr_pgj2
         */
        $attr_pgj2 = array(
            'required' => 'Nama Dosen Penguji 2 harus di isi!',
        );
        /**
         * @var		mixed	$attr_rg
         */
        ...
        $this->form_validation->set_rules('pmb', 'Dosen Pembimbing', 'trim|required', $attr_pmb);
        $this->form_validation->set_rules('pgj1', 'Dosen Penguji 1', 'trim|required', $attr_pgj1);
        $this->form_validation->set_rules('pgj2', 'Dosen Penguji 1', 'trim|required', $attr_pgj2);
        $this->form_validation->set_rules('rg', 'Ruangan', 'trim|required', $attr_rg);
    }
}
